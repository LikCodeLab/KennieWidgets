package com.kennie.views.tagflow.tag3;
...
import com.kennie.views.tagflow.R;
...
public class TagLayout extends ViewGroup {
    ...
    public TagLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mInflater = LayoutInflater.from(context);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Tag3_TagLayout);
        if (a != null) {
            mHorizontalSpace = a.getDimensionPixelOffset(R.styleable.Tag3_TagLayout_horizontalSpace, 0);
            mVerticalSpace = a.getDimensionPixelOffset(R.styleable.Tag3_TagLayout_verticalSpace, 0);
            maxLines = a.getInteger(R.styleable.Tag3_TagLayout_maxLines, Integer.MAX_VALUE);
            mUsePreCache = a.getBoolean(R.styleable.Tag3_TagLayout_preCache, false);
            mMaximumSelectionCount = a.getInteger(R.styleable.Tag3_TagLayout_maximumSelectionCount, Integer.MAX_VALUE);
            mCacheMode = a.getInt(R.styleable.Tag3_TagLayout_cacheMode, CACHE_MODE_AUTO);
            mMaxTags = a.getInteger(R.styleable.Tag3_TagLayout_maxTags, Integer.MAX_VALUE);
            if (a.hasValue(R.styleable.Tag3_TagLayout_tagResId)) {
                mTagResId = a.getResourceId(R.styleable.Tag3_TagLayout_tagResId, -1);
            }
            if (a.hasValue(R.styleable.Tag3_TagLayout_tagTextSize)) {
                mTagTextSize = a.getDimensionPixelSize(R.styleable.Tag3_TagLayout_tagTextSize, 0);
            }
            if (a.hasValue(R.styleable.Tag3_TagLayout_taggBackground)) {
                mTagBackground = a.getResourceId(R.styleable.Tag3_TagLayout_taggBackground, -1);
            }
            if (a.hasValue(R.styleable.Tag3_TagLayout_tagTextColor)) {
                mTagTextColor = a.getColorStateList(R.styleable.Tag3_TagLayout_tagTextColor);
            }
            if (a.hasValue(R.styleable.Tag3_TagLayout_tagTextHorizontalPadding)) {
                mTagTextHorizontalPadding = a.getDimensionPixelOffset(R.styleable.Tag3_TagLayout_tagTextHorizontalPadding, 0);
            }
            if (a.hasValue(R.styleable.Tag3_TagLayout_tagTextVerticalPadding)) {
                mTagTextVerticalPadding = a.getDimensionPixelOffset(R.styleable.Tag3_TagLayout_tagTextVerticalPadding, 0);
            }
            if (a.hasValue(R.styleable.Tag3_TagLayout_tagSelectMode)) {
                mTagSelectMode = a.getInt(R.styleable.Tag3_TagLayout_tagSelectMode, SELECT_MODE_NONE);
            }
            if (a.hasValue(R.styleable.Tag3_TagLayout_tagMinWidth)) {
                mTagMinWidth = a.getDimensionPixelOffset(R.styleable.Tag3_TagLayout_tagMinWidth, 0);
            }
            a.recycle();
        }
        if (mUsePreCache) {
