 ...
 */
public class ExampleStateViewsAdapter extends BaseQuickAdapter<String, BaseViewHolder> {

    public ExampleStateViewsAdapter() {
        super(android.R.layout.simple_list_item_1);
    }

    public ExampleStateViewsAdapter(@Nullable List<String> data) {
