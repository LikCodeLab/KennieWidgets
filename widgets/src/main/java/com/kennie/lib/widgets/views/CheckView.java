...
public class CheckView extends View implements Checkable {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        bgNormalColor = typedArray.getColor(R.styleable.CheckView_cv_bg_normal_color, getColor(R.color.checkview_bg_normal_color));
        bgCheckedColor = typedArray.getColor(R.styleable.CheckView_cv_bg_checked_color, getColor(R.color.checkview_bg_checked_color));

        enableBorder = typedArray.getBoolean(R.styleable.CheckView_cv_enable_border, Boolean.TRUE);
        borderNormalColor = typedArray.getColor(R.styleable.CheckView_cv_border_normal_color, getColor(R.color.checkview_border_normal_color));
        borderCheckedColor = typedArray.getColor(R.styleable.CheckView_cv_border_checked_color, getColor(R.color.checkview_border_checked_color));

        tickColor = typedArray.getColor(R.styleable.CheckView_cv_tick_color, getColor(R.color.checkview_tick_color));
