 ...
 */
public class SlantedTextView2 extends View {
    ...
    public SlantedTextView2(Context context) {
        this(context, null);
    }

    public SlantedTextView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlantedTextView2(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.SlantedTextView2);

        setText(array.getString(R.styleable.SlantedTextView2_android_text));
        setTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.SlantedTextView2_android_textSize,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 12, getResources().getDisplayMetrics())));
        setTextColor(array.getColor(R.styleable.SlantedTextView2_android_textColor, Color.WHITE));
        setTextStyle(Typeface.defaultFromStyle(array.getInt(R.styleable.SlantedTextView2_android_textStyle, Typeface.NORMAL)));
        setGravity(array.getInt(R.styleable.SlantedTextView2_android_gravity, Gravity.END));
        setColorBackground(array.getColor(R.styleable.SlantedTextView2_android_colorBackground, getAccentColor()));
        setTriangle(array.getBoolean(R.styleable.SlantedTextView2_base_triangle, false));
