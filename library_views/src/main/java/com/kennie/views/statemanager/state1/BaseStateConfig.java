        ...
        if (loadingViewHolder == null) {
            loadingViewHolder = new CustomizedViewHolder() {
                ...
                public void onViewCreated(View view) {
                    ...
                    addTextViewWithPadding(R.string._loading, Color.GRAY);
                }
            };
        }
    ...
    public IViewHolder getEmptyViewHolder() {
        if (emptyViewHolder == null) {
            emptyViewHolder = new CustomizedViewHolder() {
                @Override
                public void onViewCreated(View view) {
                    addImageView(R.drawable._icon_vector_state_empty);
                    addTextViewWithPadding(R.string._state_empty_data, Color.GRAY);
                }
            };
        }
        ...
        if (errorViewHolder == null) {
            errorViewHolder = new CustomizedViewHolder() {
                ...
                public void onViewCreated(View view) {
                    ...
                    addImageView(R.drawable._icon_vector_state_error);
                    if (!TextUtils.isEmpty(getMsg())) {
                        ...
                        addTextView(R.string._state_error, Color.GRAY);
                    } else {
                        addTextViewWithPadding(R.string._state_error, Color.GRAY);
                    }
                }
            };
        }
    ...
    public IViewHolder getLoginViewHolder() {
        if (loginViewHolder == null) {
            loginViewHolder = new CustomizedViewHolder() {
                @Override
                public void onViewCreated(View view) {
                    addImageView(R.drawable._icon_state_login);
                    addTextViewWithPadding(R.string._state_login_no, Color.GRAY);
                    ...
                    button.setText(R.string._login);
                    addView(button);
                }
            };
        }
        ...
        if (noNetworkViewHolder == null) {
            noNetworkViewHolder = new CustomizedViewHolder() {
                ...
                public void onViewCreated(View view) {
                    ...
                    addImageView(R.drawable._icon_vector_state_nerwork);
                    addTextViewWithPadding(R.string._state_network_error, Color.GRAY);
                }
            };
        }
