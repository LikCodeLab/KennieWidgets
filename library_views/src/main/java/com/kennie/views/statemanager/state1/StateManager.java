...
import static com.kennie.views.statemanager.state1.State.STATE_CONTENT;
import static com.kennie.views.statemanager.state1.State.STATE_EMPTY;
import static com.kennie.views.statemanager.state1.State.STATE_ERROR;
import static com.kennie.views.statemanager.state1.State.STATE_LOADING;
import static com.kennie.views.statemanager.state1.State.STATE_LOGIN;
import static com.kennie.views.statemanager.state1.State.STATE_NO_NETWORK;
