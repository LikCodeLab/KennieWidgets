...
import com.kennie.lib.widgets.views.badgeview.Badge;
import com.kennie.lib.widgets.views.badgeview.BadgeImageView;
import com.kennie.lib.widgets.views.badgeview.BadgeView;
 ...
 * 演示  BadgeView
 */
public class BadgeViewExampleActivity extends AppCompatActivity implements View.OnClickListener , SeekBar.OnSeekBarChangeListener, TextWatcher, CompoundButton.OnCheckedChangeListener{
    private static String TAG = BadgeViewExampleActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_badgeview_example);
